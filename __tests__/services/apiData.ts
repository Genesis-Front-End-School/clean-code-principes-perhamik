import type {AuthResponseData, CourseSingleType, CoursesResponseData} from '@/src/types'

export const authResponse: AuthResponseData = {
	token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJlYTRlNDQ0ZC05MzM0LTRmNDItOWFmYy02YTkyYWFjNTM3ODMiLCJwbGF0Zm9ybSI6InN1YnNjcmlwdGlvbnMiLCJpYXQiOjE2ODM1NzI4ODgsImV4cCI6MTY4MzU3Mzc4OH0.smCysHbE2hlsZvjKGEzHk9rvLdH_4j0bp8owFjlcnm4',
}
export const courses: CoursesResponseData = {
	courses: [
		{
		...
		},
		{
			...
			meta: {
				...
				skills: ['Mutual respect', 'Ahcieving intimacy ', 'Building trust ', 'Managing conflicts', 'Open communication'],
				courseVideoPreview: {
...
export const course: CourseSingleType = {
	id: '352be3c6-848b-4c19-9e7d-54fe68fef183',
	title: 'Lack of Motivation & How to Overcome It',
	tags: ['productivity'],
	launchDate: '2023-03-06T16:50:06.000Z',
